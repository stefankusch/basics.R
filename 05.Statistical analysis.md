...
```
The output would look like this, here suggesting statistically significant difference between the two groups:
```R
	Welch Two Sample t-test

data:  value by sample
t = -46.883, df = 569.09, p-value < 2.2e-16
alternative hypothesis: true difference in means between group df and group df.2 is not equal to 0
95 percent confidence interval:
 -32.46171 -29.85113
sample estimates:
  mean in group df mean in group df.2 
          64.48130           95.63771
```
...
```
Similar to the Welch test, the test produces an output like this:
```R
	Two Sample t-test

data:  value by sample
t = -46.883, df = 598, p-value < 2.2e-16
alternative hypothesis: true difference in means between group df and group df.2 is not equal to 0
95 percent confidence interval:
 -32.46157 -29.85127
sample estimates:
